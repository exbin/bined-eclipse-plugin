...
public class InsertDataPanel extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        optionsList.setCellRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, @Nullable Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                return super.getListCellRendererComponent(list, ((InsertDataMethod) value).getName(), index, isSelected, cellHasFocus);
            }
        });
    ...
    private javax.swing.JList<InsertDataMethod> optionsList;
