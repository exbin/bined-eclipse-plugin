...
/**
 * Documents docking mapping for BinEd Eclipse plugin.
 */
@NullMarked
public final class BinEdEclipseDocking implements MultiDocking {
    ...
    public void activeDocumentChanged() {
        ...
        contextManager.changeActiveState(ContextSearch.class, dataComponent.getSearchController().orElse(null));
